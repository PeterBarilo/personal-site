...
const Projects = () => {
  const projects = [
    ...
    },
    {
      ...
      img: '/aesonline.png',
      description: "A responsive, user-friendly web application that allows users to input text and receive an Advanced Encryption Standard encrypted output that can be downloaded or saved.",
